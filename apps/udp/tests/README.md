...
- 📖 [**Unit Testing Guide (`apps/udp/docs/unit_testing.md`)**](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/apps/udp/docs/unit_testing.md): Testing methodology, mock strategies, fail-fast validations, and CI pipeline rules.
- 📖 [**Integration Testing Guide (`apps/udp/docs/integration_testing.md`)**](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/apps/udp/docs/integration_testing.md): Live GCP validation across BigQuery, GCS landing, Cloud Run Jobs, and Cloud Composer 2.
...
```bash
.venv/bin/python3 -m pytest -m integration -v apps/udp/tests/integration
```
...
- **BigQuery Datasets & Schema Validation**:
  ```bash
  .venv/bin/python3 -m pytest -v apps/udp/tests/integration/test_bigquery_datasets.py
  ```
...
- **Cloud Storage Landing & Config Buckets**:
  ```bash
  .venv/bin/python3 -m pytest -v apps/udp/tests/integration/test_gcs_landing.py
  ```
  *Validates `bkt-elementl-509009-udp-bronze-raw` and `bkt-elementl-509009-udp-configs/sources/`.*

- **Audit Telemetry & Watermarks**:
  ```bash
  .venv/bin/python3 -m pytest -v apps/udp/tests/integration/test_audit_logging.py
  ```
...
- **Cloud Run Jobs & Artifact Registry**:
  ```bash
  .venv/bin/python3 -m pytest -v apps/udp/tests/integration/test_cloud_run_jobs.py
  ```
...
- **Cloud Composer Environment & DAG Sync**:
  ```bash
  .venv/bin/python3 -m pytest -v apps/udp/tests/integration/test_composer_dags.py
  ```
