...
All unit tests reside in [`app/udp/tests/unit/`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit):
...
### Module 1: Base Extractor ([`test_base_extractor.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_base_extractor.py))
...
### Module 2: Bulk & Tabular Extractor ([`test_bulk_extractor.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_bulk_extractor.py))
...
### Module 3: JDBC Oracle P6 Extractor ([`test_jdbc_extractor.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_jdbc_extractor.py))
...
### Module 4: Job Configuration & Environment Contract ([`test_job_config.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_job_config.py))
...
### Module 5: NetSuite SuiteQL Extractor ([`test_suiteql_extractor.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_suiteql_extractor.py))
...
### Module 6: Dynamic DAG Factory ([`test_udp_dag_factory.py`](file:///usr/local/google/home/anikethd/elementl/ELEMENTL/elementl-data-ingestion-fw/app/udp/tests/unit/test_udp_dag_factory.py))
...
.venv/bin/python3 -m pytest -v app/udp/tests/unit/test_udp_dag_factory.py
```

### 4.4 Run with Test Coverage
```bash
.venv/bin/python3 -m pytest -m unit --cov=app/udp/cloud-run-jobs --cov=app/udp/composer/dags -v app/udp/tests/unit
```
...
- name: 'python:3.11'
  ...
  args:
    ...
    - |
      ...
      pytest -m unit -v --junitxml=test-results/unit.xml app/udp/tests/unit
```
