...
"""Containerized Cloud Run Ingestion Job: bulk-ingestion."""
...
logger = logging.getLogger("bulk-ingestion")
...
def main() -> int:
    ...
    logger.info(
        "Starting bulk-ingestion worker | project=%s | bucket=%s | task_id=%s | source_table=%s",
        project_id,
        raw_bucket,
        task_id,
        source_table,
