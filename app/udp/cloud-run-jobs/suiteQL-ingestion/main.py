...
"""Containerized Cloud Run Ingestion Job: suiteQL-ingestion."""
...
logger = logging.getLogger("suiteQL-ingestion")
...
def main() -> int:
    ...
    logger.info(
        "Starting suiteQL-ingestion worker | project=%s | bucket=%s | task_id=%s | source_table=%s",
        project_id,
        raw_bucket,
        task_id,
        source_table,
